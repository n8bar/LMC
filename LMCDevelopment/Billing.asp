...
<title>Billable Events</title>

<script type="text/javascript">

var listSrc='billinglist.asp';
var taskID=0<%=TaskID%>;
var topTab;
...
function Resize() {
	...
	try { var H2=Gebi('Top').offsetHeight+Gebi('mainToolbar').offsetHeight+Gebi('SearchBar').offsetHeight
		Gebi('ListBody').style.height = (H-H2)+('px') } catch(e) { };//96
...
<div id=newEventModal>
	...
	<div id=ListBody style="">
		<iframe id=eventList src="BillingList.asp"></iframe>
	</div>
