  ...
  <!--<div class="PageBreak"><hr/></div>-->
	...
	<div class="PrintBody">
		...
		<%
			...
			Do While Not rs4.EOF
				...
				If PrintChecked = "True" then
					...
					SysSalesTax = rs4("SalesTax") : if SysSalesTax = "" or (IsNull(SysSalesTax)) then SysSalesTax = 0
					SysTotal = rs4("TotalSale")
					...
					MoneyFormat = FormatCurrency((SysTotal-SysSalesTax),2)
					SysNotes = rs4("Notes")
		...
		<%
			...
			TotalsTotal = SubTotal+TotalTax
			
			TotalsTotal=Fix(TotalsTotal*100)/100
		%>
				<div class="Line">
