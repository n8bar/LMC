...
Do Until rs.EOF
	...
	<div id=Row<%=RowNum%> class=Row>
		...
		<div id=DelBox<%=RowNum%> class="DelBox RowItem">
			<img class="DelTime" src="../../TMCDevelopment/images/delete_16.png" title="Delete"
...
<button id="New" onClick="NewTime('<%=ReportDate%>', <%=ProjID%>, '<%=ProjName%>');"><div class="vPadding3"></div><img id="imgPlus" src="../../TMCDevelopment/images/plus_16.png">New
</button>
