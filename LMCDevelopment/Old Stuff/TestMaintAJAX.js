...
function LoadNotes(OrderBy)
{
	...
	if (OrderBy != Order){
		OldMOColor[OrderHeadId] = '00C';
		Order = OrderBy;
	}
	xmlHttp = GetXmlHttpObject();
	xmlHttp.onreadystatechange = ReturnLoadNotes;
	xmlHttp.open('Get','TestMaintASP.asp?action=LoadNotes&OrderBy='+Order, true);
	xmlHttp.send(null);
}
...
if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-LoadNotes request.');
}	}	}////////////////////////////////////////////////////////////////////////////
...
function SearchCust()
{
	  ...
	  xmlHttp.open('Get','TestMaintASP.asp?action=FindCust&CustText='+CustText+'', true);
	  xmlHttp.send(null);
}
...
function ReturnGetCustomerForNewProj()
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-SearchCust request.');
}	}	}
//-------------------------------------------------------------------------------------------------
...
function SaveTask()
{
	...
	var HTTP = 'TestMaintASP.asp?action=SaveTask';
...
function ReturnSaveTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-SaveTask request.');
		}
	}
}
...
function DelTask(NoteID)
{
	...
	xmlHttp.open('Get','TestMaintASP.asp?action=DelTask&NoteID='+NoteID, true);
	xmlHttp.send(null);
}
...
function ReturnDelTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-DelTask request.');
		}
	}
}
...
{
	//alert(txtDate.value+txtJob.value);
	var HTTP = 'TestMaintASP.asp?action=UpdateTask';
...
function ReturnUpdateTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-UpdateTask request.');
}	}	}
//--------------------------------------------------------------------------------------
...
//	HttpText = 'TestMaintASP.asp?action=ArchiveTask&NoteID='+NoteID;
	//alert(HTTP);
...
function ReturnArchiveTask() 
{
	if (xmlHttp.readyState == 4)
	{
		if (xmlHttp.status == 200)
		{
			...
			if(Progress!=5)
			{alert('Progress must be \'Done\' before archiving. ProgressID:'+Progress); return false;}
		...
		{
			AjaxErr('There was a problem with the TestMaint-ArchiveTask request.',HttpText);
}	}	}
//-----------------------------------------------------
//Restores an old task from the Archive
function Activate(NoteID)
{
	if(!confirm('Do you really want to Re-Activate this task?')){return false;}
	var HTTP = 'TestMaintASP.asp?action=Activate';
	HTTP += '&NoteID='+NoteID;
	//alert(HTTP);
...
function ReturnActivate() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-Activate request.');
}	}	}
//-----------------------------------------------------
...
function ProgressClick(NoteID,Phase,DivID,Color,Txt,ColumnID)
{
	...
	var HTTP = 'TestMaintASP.asp?action=UpdateProgress&NoteID='+NoteID+'&Phase='+Phase+'&ColumnID='+ColumnID+''; // alert (HTTP);
	xmlHttp = GetXmlHttpObject();
...
function ReturnProgressClick() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-ProgressClick request.');
}	}	}
//-----------------------------------------------------------------------------------------------------------------------
...
function PriClick(NoteID,Phase,DivID,Color,Txt)
{
	...
	var HTTP = 'TestMaintASP.asp?action=UpdateProgress&NoteID='+NoteID+'&Phase='+Phase+'&ColumnID=Priority';
	xmlHttp = GetXmlHttpObject();
...
function ReturnPriClick() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the TestMaint-PriClick request.');
}	}	}
//-----------------------------------------------------------------------------------------------------------------------
