...
<script type="text/javascript" src="../../TMCDevelopment/Old Stuff/CalendarMain-JS.js"></script>
<script type="text/javascript" src="../../TMCDevelopment/Old Stuff/CalendarCreate.js"></script>
<script type="text/javascript" src="../../TMCDevelopment/Old Stuff/CalendarJS.js"></script>
<script type="text/javascript" src="../../TMCDevelopment/Old Stuff/CalendarAJAX.js"></script>
<script type="text/javascript" src="../../TMCDevelopment/Old Stuff/DragNDropJS.js"></script>
<SCRIPT type="text/javascript" src="../../TMCDevelopment/Old Stuff/dhtmlgoodies_calendar.js?random=20060118"></script>
...
<link rel="stylesheet" href="../../TMCDevelopment/Old Stuff/CalendarCSS.css" media="screen">
<link rel="stylesheet" href="../../TMCDevelopment/Old Stuff/CalendarMain-CSS.css" media="screen">
<link type="text/css" rel="stylesheet" href="../../TMCDevelopment/Old Stuff/dhtmlgoodies_calendar.css?random=20051112" media="screen">
    ...
    <div class="ViewsTabs">
    	...
    	<div id="MonthsTab" onMouseUp="showMonths()" class="MonthsTab">Months</div>
			...
			<small style="float:right;">
				<a href="../../TMCDevelopment/Old Stuff/calendarMain.asp" target="_self" style="text-decoration:underline; font-family:Arial, Helvetica, sans-serif;">Old Calendar</a>
				&nbsp;
			</small>
...
<div id="CalendarPlaner" style="display:block; height:100%;">
    ...
    <ul id="dragContent"></ul>
		...
		<div id="dragDropIndicator" style="background-image:url(../../TMCDevelopment/Old%20Stuff/images/ArrowUpL.gif);"></div>
    </div>
</div>  </td>
  </tr>
</table>
...
<div id="NewEventTaskBox" class="NewEventTaskBox">
	...
	<div style="font-size:18px; background-color:#1294D0; width:100%; color:#FFFFFF;">
		New Event
		<img onClick="hideEventModal();" style="cursor:pointer; float:right;" src="../../TMCDevelopment/Old Stuff/Images/close15X15.gif" width="15" height="15" />
	</div>
...
<div id="ProjectSelectionBox">
	<img onClick="this.parentNode.style.display='none';" style="cursor:pointer; float:right;" src="../../TMCDevelopment/Old Stuff/Images/close15X15.gif" width="15" height="15" />
	<br>
	<!--
        ...
        <table width="616" height="359"border="0" cellpadding="4" cellspacing="0" bgcolor="#E6F3FB">
          ...
          <tr height="16">
            ...
            <div align="left">
              ...
              <img style="cursor:pointer;"onclick="displayCalendar('FromDateTxt','mm/dd/yyyy',this)" src="../../TMCDevelopment/Old Stuff/Images/cal.gif" width="16" height="16"></div>
              </td>
          ...
          <tr height="16">
            ...
            <img style="cursor:pointer;"onclick="displayCalendar('ToDateTxt','mm/dd/yyyy',this);" src="../../TMCDevelopment/Old Stuff/Images/cal.gif" width="16" height="16"></div>            </td>
            <td align="right" valign="bottom" style="border-left: 1px solid #AAA;">
...
<ul id="dragContent"></ul>
<div id="dragDropIndicator"><img src="../../TMCDevelopment/Old Stuff/Images/Arrow20X25R2.gif"></div>
