...
.Row:hover{background-color:#FF9900;}
	...
	.Edit{min-width:28px; width:4%;}
		.btnEdit{position:relative; left:5%; width:90%; height:16px; background:none; background:url(../../TMCDevelopment/images/Pencil_16.png) no-repeat center; border-width:1px; cursor:pointer;}
