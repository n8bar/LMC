...
<div id="Toolbar" class="Toolbar">
	<button id=Back2 onClick="PGebi('PurchasingIframe').src='Purchase.html';"><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/GreenDblLeftTriangle.png"/>Back 2 Purchasing Jobs</button>
	<button id=Back onClick="PGebi('PurchasingIframe').src='PurchaseOrders.asp?ProjID=<%=ProjID%>';"><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/GreenLeftTriangle.png"/>Back 2 P.O. List</button>
	<span class="tSpacerLine"></span>
	<button onClick="Gebi('PartsBox').style.display='block';" ><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/plus_16.png"/>&nbsp;Add</button>
	<button onClick="DeletePOItem();" ><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/delete_16.png"/>&nbsp;Delete</button>
	<button id=ChangePO onClick="Gebi('ChangePOMenu').style.display='block'; Gebi('MenuFocus').focus();"	><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/SendLeft.png" />&nbsp;Move to P.O.</button>
	<button	onClick="PlusPOItem(1);" ><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/plus_16.png"/>&nbsp;Qty's+1</button>
	<button	onClick="PlusPOItem(-1);" ><img style="width:16px; height:16px;" src="../../TMCDevelopment/images/minus_16.png"/>&nbsp;Qty's-1</button>
	<button	id="ReloadFrame" style="float:right;" onClick="window.location.reload();"><img src="../../TMCDevelopment/images/reloadblue24.png" style="width:100%; height:100%;"/></button>
</div>
...
<div id="Body">
	<div id=HeadingTop>
		...
		-->
		<div class=HeadSection><img id=Logo src="../../TMCDevelopment/images/TricomLogo2.jpg"/></div>
