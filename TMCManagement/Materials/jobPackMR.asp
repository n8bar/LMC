...
'███████████████████████████████████████████████
	...
	<div class=row id=row<%=r%> >
		...
		<div class="w5p p0 taC" ><%if invQty > 0 Then %> <button class=tButton0x24 style="float:none;" onClick="movePart(<%=r%>);"><img height=20 src="../images/CyanDblRight24.png"/></button> <%End IF%></div>
		<div class="w11p h100p ffConsolas">
