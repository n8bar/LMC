	...
	<div id="LeftContainer" class="LeftContainer">
		...
		<div id="AreaContainer" class="AreaContainer">
			...
			<div id="AreaTopBox" class="AreaTopBox">
				...
				<img class=DateButton onClick="PGebi('oldBidderFrame').style.display='none'; displayCalendar('SearchDateFrom','mm/dd/yyyy',this);" src="../Images/cal.gif" width="16" height="16" />
				<br/>
				...
				<img class=DateButton onClick="PGebi('oldBidderFrame').style.display='none'; displayCalendar('SearchDateTo','mm/dd/yyyy',this);" src="../Images/cal.gif" width="16" height="16" />
...
<div id="NewSystemBox" class="NewSystemBox">
	...
	<div class="">
		...
		<img style="cursor:pointer;"onclick="displayCalendar('NewSysDate','mm/dd/yyyy',this)" src="../Images/cal.gif" width="16" height="16">	</div>
		...
		<div class="PrintTopBoxR">
			<div class="PrintSetupTitles">Signed By Tricom</div>
				...
				<div class="PrintSetupTextInput">
					...
					<img style="cursor:pointer;"onclick="displayCalendar('PrintDate','mm/dd/yyyy',this)" src="../Images/cal.gif" width="16" height="16">				</div>
			</div>
...
<div id="ObtainBidBox" class="ObtainBidBox">
	...
	<div style="text-align:center;">
		...
		<div style="float:left; margin-top:3px; height:20px;">
			<img style="cursor:pointer; float:right" onClick="displayCalendar('ObtainDate','mm/dd/yyyy',this);" src="../Images/cal.gif" width="16" height="16">
		</div>
	</div><!--
	<hr/>
