...
function LoadNotes(OrderBy)
{
	...
	HttpText='GeneralASP.asp?action=LoadNotes&OrderBy='+Order;
...
if (xmlHttp.readyState == 4)
	{
		...
		{
			AjaxErr('There was a problem with the General-LoadNotes request.',HttpText);
}	}	}////////////////////////////////////////////////////////////////////////////
...
function SearchCust()
{
	  ...
	  xmlHttp.open('Get','GeneralASP.asp?action=FindCust&CustText='+CustText+'', true);
	  xmlHttp.send(null);
}
...
function ReturnGetCustomerForNewProj()
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-SearchCust request.');
}	}	}
//-------------------------------------------------------------------------------------------------
...
function SaveTask()
{
	...
	var HTTP = 'GeneralASP.asp?action=SaveTask';
...
function ReturnSaveTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-SaveTask request.');
		}
	}
}
...
function DelTask(NoteID)
{
	...
	xmlHttp.open('Get','GeneralASP.asp?action=DelTask&NoteID='+NoteID, true);
	xmlHttp.send(null);
}
...
function ReturnDelTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-DelTask request.');
		}
	}
}
...
{
	//alert(txtDate.value+txtJob.value);
	var HTTP = 'GeneralASP.asp?action=UpdateTask';
...
function ReturnUpdateTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-UpdateTask request.');
}	}	}
//--------------------------------------------------------------------------------------
...
//	{alert('Progress must be \'Done\' before archiving.'); return false;}
	...
	var HTTP = 'GeneralASP.asp?action=ArchiveTask';
	HTTP += '&NoteID='+NoteID;
	//alert(HTTP);
...
function ReturnArchiveTask() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-ArchiveTask request.');
}	}	}
//-----------------------------------------------------
...
function Activate(NoteID)
{
	...
	var HTTP = 'GeneralASP.asp?action=Activate';
	HTTP += '&NoteID='+NoteID;
	//alert(HTTP);
...
function ReturnActivate() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-Activate request.');
}	}	}
//-----------------------------------------------------
...
function ProgressClick(NoteID,Phase,DivID,Color,Txt,ColumnID)
{
	...
	var HTTP = 'GeneralASP.asp?action=UpdateProgress&NoteID='+NoteID+'&Phase='+Phase+'&ColumnID='+ColumnID+''; // alert (HTTP);
	xmlHttp = GetXmlHttpObject();
...
function ReturnProgressClick() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-ProgressClick request.');
}	}	}
//-----------------------------------------------------------------------------------------------------------------------
...
function PriClick(NoteID,Phase,DivID,Color,Txt)
{
	...
	var HTTP = 'GeneralASP.asp?action=UpdateProgress&NoteID='+NoteID+'&Phase='+Phase+'&ColumnID=Priority';
	xmlHttp = GetXmlHttpObject();
...
function ReturnPriClick() 
{
	if (xmlHttp.readyState == 4)
	{
		...
		{
			alert('There was a problem with the General-PriClick request.');
}	}	}
//-----------------------------------------------------------------------------------------------------------------------
