...
{
	parent.mX=mX+PGebi('PurchaseListFrame').offsetLeft;
	parent.mY=mY+PGebi('PurchaseListFrame').offsetTop;
...
function ArchivedPurchaseListBkGndOn(ID){document.getElementById('ArchivedPurchaseItems'+ID+'').style.background = '#E6F3FB';}

function ArchivedPurchaseListBkGndOff(ID){document.getElementById('ArchivedPurchaseItems'+ID+'').style.background ='#FFF';}
//----------------------------------------------------------------
...
function ChangeToArchive()
{
	...
	Gebi('PurchaseListFrame').src=Gebi('PurchaseListFrame').src.replace('PurchasingArchive=False','PurchasingArchive=True');
	Active='False';
}
...
function ChangeToActive()
{
	...
	//Gebi('TLItemsContainer').innerHTML = '';
	Gebi('PurchaseListFrame').src=Gebi('PurchaseListFrame').src.replace('PurchasingArchive=True','PurchasingArchive=False');
	Active='True';
}

function SortBy(NewSortBy)
{
	Gebi('PurchaseListFrame').src='PurchaseList.asp?Active='+Active+'&SortBy='+NewSortBy;
	SortedBy=NewSortBy;
...
{	
	...
	document.getElementById("PurchaseInfoBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PurchaseContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToContacts(LoopNum)
{
	...
	document.getElementById("PurchaseInfoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseContactsBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PurchaseNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToNotes(LoopNum)
{
	...
	document.getElementById("PurchaseInfoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseNotesBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PurchaseToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToToDo(LoopNum)
{
	...
	document.getElementById("PurchaseContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseToDoBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PurchaseBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToBOM(LoopNum)
{
	...
	document.getElementById("PurchaseNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseBOMBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PurchaseDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToDocs(LoopNum)
{
	...
	document.getElementById("PurchaseToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PurchaseDocsBoxBody"+LoopNum).style.display = 'block';
...
{	
  ...
  var MenuItems ='<select size= 7 class="EmployeeListInside" onchange= "CloseEmployeeList(),UpdatePurchaseManager(value,&#39;'+DivID+'&#39;,'+ID+')">'
...
function SelectTreeItem(ThisItem)
{
	...
	PGebi('PurchaseListControl').style.display='none';
	...
	if(SelectedItemType=='ItemJob'+SelectedRow)
	{
		...
		PGebi('PurchaseListControl').style.display='block';
...
function ToCal()
{
	...
	TaskList.selectedIndex=9//OrderNum of "Purchasing"
}
...
function Resize()
{
	...
	try{Gebi('PurchaseListFrame').style.height=FrameH+'px';}
	catch(e){Gebi('PurchaseListFrame').height=FrameH+'px';}
	...
	//Gebi('PurchaseListFrame').contentWindow.reload;
}
