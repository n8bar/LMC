...
<div id="Body">
	...
	<div id="Top">
		<img id="Logo" src="../Images/TCS.jpg"/>
		<div id="Weather">
			<%
			...
			<label class="WeatherLabel" style="margin-left:.03125in;" title="Sunny">
				<img class="WeatherIcon" src="../images/weather/Sunny.jpg" />
			...
			<label class="WeatherLabel" style="left:.5in;" title="Cloudy">
				<img class="WeatherIcon" src="../images/weather/Cloudy.jpg" />
			...
			<label class="WeatherLabel" style="left:1in;" title="Thunderstorms">
				<img class="WeatherIcon" src="../images/weather/Thunder.jpg" />
			...
			<label class="WeatherLabel" style="left:1.5in;" title="Rain">
				<img class="WeatherIcon" src="../images/weather/Rain.jpg" />
			...
			<label class="WeatherLabel" style="left:2in;" title="Ice">
				<img class="WeatherIcon" src="../images/weather/Ice.jpg" />
			...
			<label class="WeatherLabel" style="left:2.5in;" title="Windy">
				<img class="WeatherIcon" src="../images/weather/Windy.jpg" />
			...
			<label class="WeatherLabel" style="left:3in;" title="Snow">
				<img class="WeatherIcon" src="../images/weather/Snow.jpg" />
			...
			<label class="WeatherLabel" style="left:3.5in;" title="Cold">
				<img class="WeatherIcon" src="../images/weather/Cold.jpg" />
		...
		<div id="TopBottom">
			...
			<img id="DatePick" onClick="displayCalendar('ReportDate','mm/dd/yyyy',Gebi('ReportDate'))" src="../Images/cal.gif" />		</div>
	</div>
	...
	<div id="TimeHead">
		...
		<div id="TimeHeadRow">
			<div id="ClearH">
				<img id=DelAll src=../images/delete_16.png title="Delete Everybody's Time!!!"
				 onClick="
