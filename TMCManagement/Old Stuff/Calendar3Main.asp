...
<script type="text/javascript" src="CalendarMain-JS.js"></script>
<script type="text/javascript" src="CalendarCreate.js"></script>
<script type="text/javascript" src="CalendarJS.js"></script>
<script type="text/javascript" src="CalendarAJAX.js"></script>
<script type="text/javascript" src="DragNDropJS.js"></script>
...
<link rel="stylesheet" href="CalendarCSS.css" media="screen">
<link rel="stylesheet" href="CalendarMain-CSS.css" media="screen">
    ...
    <div class="ViewsTabs">
    	...
    	<div id="MonthsTab" onMouseUp="showMonths()" class="MonthsTab">Months</div>
			...
			<small style="float:right;">
				<a href="calendarMain.asp" target="_self" style="text-decoration:underline; font-family:Arial, Helvetica, sans-serif;">Old Calendar</a>
				&nbsp;
			</small>
...
<div id="NewEventTaskBox" class="NewEventTaskBox">
	...
	<div style="font-size:18px; background-color:#1294D0; width:100%; color:#FFFFFF;">
		New Event
		<img onClick="hideEventModal();" style="cursor:pointer; float:right;" src="Images/close15X15.gif" width="15" height="15" />
	</div>
...
<div id="ProjectSelectionBox">
	<img onClick="this.parentNode.style.display='none';" style="cursor:pointer; float:right;" src="Images/close15X15.gif" width="15" height="15" />
	<br>
	<!--
        ...
        <table width="616" height="359"border="0" cellpadding="4" cellspacing="0" bgcolor="#E6F3FB">
          ...
          <tr height="16">
            ...
            <div align="left">
              ...
              <img style="cursor:pointer;"onclick="displayCalendar('FromDateTxt','mm/dd/yyyy',this)" src="Images/cal.gif" width="16" height="16"></div>
              </td>
          ...
          <tr height="16">
            ...
            <img style="cursor:pointer;"onclick="displayCalendar('ToDateTxt','mm/dd/yyyy',this);" src="Images/cal.gif" width="16" height="16"></div>            </td>
            <td align="right" valign="bottom" style="border-left: 1px solid #AAA;">
