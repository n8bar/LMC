...
<div id="DataTabsBox" class="DataTabsBox"><!--Creates dynamic tabs-->
    ...
    <div id="EmployeeTabBox" class="TabBox2" style="background:#DCD;">
    ...
    <div id="InventoryTabBox" class="TabBox2" style="background:#9DD;">
    <div id="InventoryTab"  class="TabInner2" onClick="DataTabs('InventoryBox','InventoryTabBox');" onMouseOver="//MouseOverMarTop('InventoryTabBox')" onMouseOut="MouseOutMarTop('AssestsTabBox')">Inventory<br/> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </div>
	</div>
...
<div id=TimeBox class=MainBoxHidden style="background:#EEE7AE;">
	...
	<div id="TimeByEmp" class="MainTimeBox" style="background:none;">
		<label>
			From:<br />
			<input id="FromDate" type="text" onChange="LoadEmployeeTime();" onFocus="displayCalendar('FromDate','mm/dd/yyyy',this);" />
			<img style="cursor:pointer;" src="../Images/cal.gif" width="16" height="16"><br />
		</label>
		<label>
			To: <small>(inclusive)</small><br />
			<input id="ToDate" type="text" onChange="LoadEmployeeTime();" onFocus="displayCalendar('ToDate','mm/dd/yyyy',this);" />
			<img style="cursor:pointer;" src="../Images/cal.gif" width="16" height="16"><br /><br />
		</label>
		<div style="width:100%;" align=center >
			<button onClick="LoadEmployeeTime();" style="width:50%;">&nbsp; &nbsp; <b>Go!</b>&nbsp; &nbsp; </button>
		</div>
		<br/>
		<select id=EmpList onChange="LoadEmployeeTime();" disabled>
			<option>Employee:</option>
			<% EmployeeOptionList("active") %>
			<option value=1000 selected >All Active Employees:</option>
			<option>Employee:</option>
		</select>
		<br />
		<br />
	...
	<div id="EmployeeData" class="EmployeeData">
		...
		<div id="EmpDLTabs" class="EmpDLTabs">
			...
			<div id="EmpInfoTabBox" class="TabBox2" style="margin-left:1px; ">
				<div id=EmpInfoTab  class=TabInner2 onClick="EmpTabs('EmpInfo','EmpInfoTabBox')" style="height:10px; color:#fff;" onmouseover="MouseOverTab('EmpInfoTabBox')" onMouseOut="MouseOutTab('EmpInfoTabBox')">Employee Info</div>
			</div>
...
<input id="CBAdmin" type="checkbox" onClick="UpdateAccess(this,this.checked,'Admin')" /><label for="CBAdmin">Administration</label>
	...
	<div id=EmployeeDR class=EmployeeDR title="Employee List" >
		<div style="width:100%; height:24px; float:left; clear:both;"><button id="NewEmp" style="float:left; height:22px; margin-top:4px;" onclick="NewEmployee();">Create New</button></div>
		<%
		...
		Do Until empRS.EOF
			EmpID=empRS("EmpID")
			empName=empRS("FName")&" "&empRS("LName")
			
			MouseEvents =" onmouseover=""EmpmOver("&EmpID&");"" onmouseout=""EmpmOut("&EmpID&"); """
			onclick = " onclick=""OpenEmployee("&EmpID&");"" "
			title = "title="""&EmpID&" "&empName&" "" "

			%><div id="<%=EmpID%>" class=EmpListItem <%=MouseEvents&onclick%> ><%=empName%></div><%
			
			empRS.MoveNext
		Loop
		
		%><br class="EmpListItem"/><hr class="EmpListItem h1"/><%
...
<iframe id="InventoryBox" class="MainBoxHidden" style="background:#EFF;" src=Inventory.asp?noCache=<%=loadStamp%> ></iframe>
