...
<style>
html {margin:0; padding:0; width:100%; height:110%; background:#CCCcCC;}
body {margin:0; padding:0; width:100%; height:90%; background:#CCCcCC; overflow:hidden;}
...
.row { height:3.6667%; width:99%; font-size:14px; padding-left:.5%; background:#CCCcCC; }
...
function spitEmOut(start,end) {
	...
	for(s=1; s>=Inc; s-=Inc) {
		...
		for(cOI=start; cOI<=end; cOI++) {
		  if(cOI==1||cOI==4||cOI==6||cOI==7||cOI==8||cOI==13||cOI==9) {
				...
				//if(r<255)r++; if(g<255)g++; if(b<255)b++; 
...
//document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[0]+') solid;">Test/Maint</div>');
document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[1]+') solid; padding:3px 0 0 0;">Projects/Jobs</div>');
//document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[2]+') solid;">IT / Software&nbsp;Dev</div>');
//document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[3]+') solid;">General Notes</div>');
...
//document.write('<br/>');
//document.write('<div class="row titles" style="max-height:32px;">');
//document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[9]+') solid;">Engineering</div>');
//document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[11]+') solid;">Private</div>');
//document.write('	<div class=dBox style="color:#000; border:1px rgb('+cOrder[12]+') solid;"><big><big>☺</big></big></div>');
//document.write('</div>');
//spitEmOut(7,13);
</script>
