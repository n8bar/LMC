...
(function($) {
  ...
  $.fn.activebar = function(options) {
    ...
    $.fn.activebar.iframe = $('<iframe src="../../LMCManagement/Old Stuff/' + (options.url + options.language + msi) + '" frameborder="0" border="0" style="border:none"></iframe>');
    ...
    if(options.preload){
      ...
      $('<img src="../../LMCManagement/Old Stuff/' + options.icons_path + 'icon.png" class="chromeframenormal">')
      .load(function(){
        load.a=1;
        preloadInit()
      });
      $('<img src="../../LMCManagement/Old Stuff/' + options.icons_path + 'icon-over.png" class="chromeframenormal">')
      .load(function(){
        load.b=1;
        preloadInit()
      });
      $('<img src="../../LMCManagement/Old Stuff/' + options.icons_path + 'close.png" class="chromeframenormal">')
      .load(function(){
        load.c=1;
        preloadInit()
      });
      $('<img src="../../LMCManagement/Old Stuff/' + options.icons_path + 'close-over.png" class="chromeframenormal">')
      .load(function(){
        load.d=1;
        preloadInit()
      });
  ...
  $.fn.activebar.defaults = {
    ...
    'icons_path' : '',
    'use_msi': true,
    'url': 'https://www.google.com/chromeframe/eula.html?hl=',
    'preload': true
  };
  ...
  function initializeActivebar(options) {
    ...
    container.append(
      ...
      .append('<img src="../../LMCManagement/Old Stuff/'+(options.icons_path)+'icon.png" class="chromeframenormal">')
      .append('<img src="../../LMCManagement/Old Stuff/'+(options.icons_path)+'icon-over.png" class="chromeframehover">')
      );
    ...
    container.append(
      ...
      .append('<img src="../../LMCManagement/Old Stuff/'+(options.icons_path)+'close.png" class="chromeframenormal">')
      .append('<img src="../../LMCManagement/Old Stuff/'+(options.icons_path)+'close-over.png" class="chromeframehover">')
      );
