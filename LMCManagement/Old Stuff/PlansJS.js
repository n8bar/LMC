...
{
	parent.mX=mX+PGebi('PlanListFrame').offsetLeft;
	parent.mY=mY+PGebi('PlanListFrame').offsetTop;
...
function ArchivedPlanListBkGndOn(ID){document.getElementById('ArchivedPlanItems'+ID+'').style.background = '#E6F3FB';}

function ArchivedPlanListBkGndOff(ID){document.getElementById('ArchivedPlanItems'+ID+'').style.background ='#FFF';}
//----------------------------------------------------------------
...
function ChangeToArchive()
{
	...
	Gebi('PlanListFrame').src=Gebi('PlanListFrame').src.replace('PlansArchive=False','PlansArchive=True');
	Active='False';
}
...
function ChangeToActive()
{
	...
	//Gebi('TLItemsContainer').innerHTML = '';
	Gebi('PlanListFrame').src=Gebi('PlanListFrame').src.replace('PlansArchive=True','PlansArchive=False');
	Active='True';
}

function SortBy(NewSortBy)
{
	Gebi('PlanListFrame').src='PlanList.asp?Active='+Active+'&SortBy='+NewSortBy;
	SortedBy=NewSortBy;
...
{	
	...
	document.getElementById("PlanInfoBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PlanContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToContacts(LoopNum)
{
	...
	document.getElementById("PlanInfoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanContactsBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PlanNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToNotes(LoopNum)
{
	...
	document.getElementById("PlanInfoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanNotesBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PlanToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToToDo(LoopNum)
{
	...
	document.getElementById("PlanContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanToDoBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PlanBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToBOM(LoopNum)
{
	...
	document.getElementById("PlanNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanBOMBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("PlanDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToDocs(LoopNum)
{
	...
	document.getElementById("PlanToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("PlanDocsBoxBody"+LoopNum).style.display = 'block';
...
{	
  ...
  var MenuItems ='<select size= 7 class="EmployeeListInside" onchange= "CloseEmployeeList(),UpdatePlanManager(value,&#39;'+DivID+'&#39;,'+ID+')">'
...
function SelectTreeItem(ThisItem)
{
	...
	PGebi('PlanListControl').style.display='none';
	...
	if(SelectedItemType=='ItemJob'+SelectedRow)
	{
		...
		PGebi('PlanListControl').style.display='block';
...
function ToCal()
{
	...
	TaskList.selectedIndex=8//OrderNum of "Engineering /Plans"
}
...
function Resize()
{
	...
	try{Gebi('PlanListFrame').style.height=FrameH+'px';}
	catch(e){Gebi('PlanListFrame').height=FrameH+'px';}
	...
	//Gebi('PlanListFrame').contentWindow.reload;
}
