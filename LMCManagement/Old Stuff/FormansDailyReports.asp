...
<div id=NewReportBox>
	...
	<img id=NewDateImg onClick="displayCalendar('NewDate','mm/dd/yyyy',NewDate);" src="../../LMCManagement/Images/cal.gif">
	<br/>
	<br/>
	<br/>
	<br/>
...
<div id=Toolbar align=Left>
	&nbsp; &nbsp;<button id=New onClick="ShowNewReportBox();"><div class="vPadding3"></div><img id=imgPlus src="../../LMCManagement/images/plus_16.png"/> New</button>
</div>
