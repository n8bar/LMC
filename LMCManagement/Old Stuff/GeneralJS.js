...
{
	txtJob.value = document.getElementById('sizeJob'+NoteID).innerHTML;
	txtDate.value = document.getElementById('Date'+NoteID).innerHTML;
	txtCust.value = document.getElementById('sizeCust'+NoteID).innerHTML;
	HiddenNoteID.value = NoteID;
	
	for(var i=0;i<selArea.length;i++)
	{
		if (selArea[i].innerText == document.getElementById('Area'+NoteID).innerHTML)
		{	selArea.selectedIndex = i;}
	}
	for(var i=0;i<selAttn.length;i++)
	{
		if (selAttn[i].innerText == document.getElementById('Attn'+NoteID).innerHTML)
		{	selAttn.selectedIndex = i;}
	}
	
	txtNotes.innerText = document.getElementById('HiddenNotes'+NoteID).value;
...
{
	HeadJob.style.color='#000';
	HeadJob.style.fontSize='12px';
	HeadCust.style.color='#000';
	HeadCust.style.fontSize='12px';
	HeadArea.style.color='#000';
	HeadArea.style.fontSize='12px';
	HeadAttn.style.color='#000';
	HeadAttn.style.fontSize='12px';
	HeadDate.style.color='#000';
	HeadDate.style.fontSize='12px';
	HeadPri.style.color='#000';
...
function ToCal(NoteID)
{
	...
	Target.getElementById('EventTitleText').value = document.getElementById('sizeJob'+NoteID).innerHTML;
	Target.getElementById('FromDateTxt').value = document.getElementById('Date'+NoteID).innerHTML;
	Target.getElementById('ToDateTxt').value = document.getElementById('Date'+NoteID).innerHTML;
	...
	{		
		//alert(i);
		if(AttnSel[i].innerText == document.getElementById('Attn'+NoteID).innerHTML)
		{
	...
	{		
		//alert(i);
		if(TaskList[i].innerText != TaskList[i].innerText.replace('General',''))
		{
	...
	{		
		//alert(i);
		if(AreaSel[i].innerText == document.getElementById('Area'+NoteID).innerHTML)
		{
...
function showProgressMenu(DivID,NoteID,ColumnID,X,Y)
{
	...
	//var i = 1
	{
		MenuItems +='<div class="ProgressItems" onclick="ProgressClick('+NoteID+','+pArray[i][1]+',&#39;'+DivID+'&#39;,'
...
function showPriMenu(DivID,NoteID)
{
	...
	//var i = 1
	{
		MenuItems +='<div class="ProgressItems" onclick="PriClick('+NoteID+','+prArray[i][1]+',&#39;'+DivID+'&#39;,'
