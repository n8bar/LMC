...
<div id="NewJobBox" class="ModalBox" style="background:#<%=BgColor%>;">
  ...
  <img style="cursor:pointer;"onclick="displayCalendar('NewJobDate','mm/dd/yyyy',this)" src="../../TMCDevelopment/Images/cal.gif" width="16" height="16"><br/>
	<br/>
	<br/>
  ...
  <img style="cursor:pointer;"onclick="displayCalendar('NewJobDue','mm/dd/yyyy',this)" src="../../TMCDevelopment/Images/cal.gif" width="16" height="16"><br/>
	<br/>
	<br/>
	<br/>
	<br/>
	...
	<div id="Lists" class="Lists" align="center">
		...
		<div id="SearchSort" class="Toolbar" align="center" style="text-align:center; width:100; margin-left:auto; margin-right:auto;">
			<div id="SearchSortInner" style="width:100%;">
				...
				<button id="NewJob" onClick=" Gebi('NewJobBox').style.display='block'; Gebi('ModalScreen').style.display='block'; Gebi('NewJobTitle').focus();"><img src="../../TMCDevelopment/images/plus_16.png"/>Add New Job</button>
		...
		<div id="ToDoToolbar" class="Toolbar" style="min-width:992px; margin-left:auto; margin-right:auto;">
			...
			<div style="float:left; width:33%; min-width:33%; height:100%; min-height:100%; overflow:hidden;">
				<div id="JobListControl" style="float:left; width:100%; height:100%; min-height:100%;">
					...
					<button onClick="NewEmpList();"><img src="../../TMCDevelopment/images/plus_16.png"/>Add</button>
				</div>
				...
				<div id="ItemListControl" style="float:left; display:none; width:100%;" align="left">
					...
					<button onClick="NewItemList();" style="width:12%; max-width:35%; float:left;"><img src="../../TMCDevelopment/images/plus_16.png"/>Add</button>
				</div>
				...
				<div id="ListItemControl" style="float:left; display:none; width:100%;">
					...
					<button onClick="NewListItem();" style="width:12%; max-width:35%;"><img src="../../TMCDevelopment/images/plus_16.png"/>Add</button>
				</div>
			...
			<div style="float:right; width:33%">
				<button id="btnRemove" style=" margin-left:2%; text-overflow:ellipsis;" onClick="DelTreeItem();"><img src="../../TMCDevelopment/images/minus_16.png"/>Remove <span id="RemItemName"></span></button>
			</div>
		</div>
