	...
	if(document.all)ev = event;
		...
		if(Box_Event_Click==1)
		{
			...
			document.getElementById('BubbleTop').innerHTML = ('<div align="right" class="BubbleTopPlain">')+
								  ('<div class="TopDivTopPlain"><a href="Javascript:Void()" onMouseUp="hideToolTip();"><img src="../../LMCManagement/Old Stuff/Images/close12X12.gif" height="12px" width-"12px" border="0"  margin="0" padding="0"/></a></div>')+
								  ('</div>');
