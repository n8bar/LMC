...
<div id=Toolbar class="Toolbar" style="position:relative; top:-8px;" align=Left>
	...
	<button id=Back onClick="PGebi('PurchasingIframe').src='Purchase.html';"><img style="width:16px; height:16px;" src="../../LMCManagement/images/GreenLeftTriangle.png"/><div>Back 2 Purchasing Jobs</div></button>
	<span class="tSpacerLine" style="position:relative; top:-4px; margin-right:5px;"></span>
	<button id=New onClick="ShowNewPOBox();"><img id=imgPlus src="../../LMCManagement/images/plus_16.png"/><div>New</div></button>
	<%
	If BomIsGenerated="True" Then%><button id=New onClick="GeneratePOs(<%=ProjID%>);"><img id=imgPlus src="../../LMCManagement/images/plus_16.png"/><div>Generate P.O.'s from Bill of Materials.</div></button>
	<%End If%>
    <button id=New onClick="DelSelected();"><img id=imgMinus src="../../LMCManagement/images/minus_16.png"/><div>Delete Selected</div></button>
</div>
