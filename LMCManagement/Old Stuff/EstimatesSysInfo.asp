...
<div id="LeftBox">
	...
	<div id="LT" style="height:84px;">
		...
		<div class="Row">
			...
			<div class="SystemInfoDiv" style="padding:0; height:20px;">
				...
				/>
				<div align="center" style=" float:left; clear:right;"><img class="Cal" onClick="displayCalendar('DateBid','mm/dd/yyyy',this)" src="../../LMCManagement/Images/cal.gif"/></div>
			</div>
		</div>
		...
		<div class="Row">
			...
			<div class="SystemInfoDiv" style="padding:0; height:20px;">
				...
				/>
				<div align="center" style=" float:left; clear:right;"><img class="Cal" onClick="displayCalendar('DateWon','mm/dd/yyyy',this)" src="../../LMCManagement/Images/cal.gif"/></div>
			</div>
		</div>
		<!--
		<div class="Row">
	...
	<div id="LM" style="height:202px;">
		<div class="SystemInfoLTName" style="border-top:none;">Costing Breakdown</div>
		
		<div class="Row">
			<div class="SystemInfoTag">Materials &nbsp;</div>
			<DIV id=PartsSell class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoParts" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag">Labor &nbsp;</div>
			<DIV id=LaborSell class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoLabor" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag">Travel &nbsp;</div>
			<DIV id=Travel class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoTravel" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag">Equipment &nbsp;</div>
			<DIV id=Equipment class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoEquipment" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag">Overhead &nbsp;</div>
			<DIV id=OH class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoOverhead" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag">Profit &nbsp;</div> 
			<DIV id=Profit class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoProfit" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag" align="right">
				Subtotal &nbsp;
				<div style="float:left;" align="left">
					<INPUT style="MARGIN: 1px 0px 0px 4px" id=ckRound onchange=UpdateRound(this.checked); type=checkbox>
					<LABEL style="POSITION: relative; TOP:-1px; font-weight:normal; font-size:10px;" for=ckRound>Round up to next $10</LABEL>
				</div>
			</div> 
			<DIV id=Subtotal class="SystemInfoDiv4 Stats" style="font-size:16px; font-weight:normal;"></DIV>
			<div id="SysInfoSubtotal" class="SystemInfoDiv4 Stats" style="font-size:16px; font-weight:normal;">100%</div>
		</div>

		<div class="Row"> 
			<div class="SystemInfoTag">Tax &nbsp;</div>
			<DIV id=Tax class="SystemInfoDiv4 Stats"></DIV>
			<div id="SysInfoTax" class="SystemInfoDiv4 Stats"></div>
		</div>

		<div class="Row">
			<div class="SystemInfoTag"><big>Total</big> &nbsp;</div> 
			<DIV id=TotalSell class="SystemInfoDiv4 Stats" style="font-size:16px;"></DIV>
			<div id="SysInfoTotal" class="SystemInfoDiv4 Stats" style="font-size:16px;"></div>
		</div>

	</div>	
	
					
	<div id="LB" style="width:100%; height:60px; padding:0;">

		<div class="Row" style="height:auto;">
			
			<DIV class=SystemInfoLRBBox style="width:90.72%; height:78px; float:left;">
				
				<div class="SystemInfoLTName" style="border-top:none;">System Area</div>
		
				<div class="Row">
					<div class="SystemInfoTag">
						Sq. Ft. &nbsp;
						<DIV style="float:left;" align=left>
							<INPUT style="MARGIN: 1px 0px 0px 4px" id=ckIncludeSqFt onchange=UpdateSqFtAdd(this.checked); type=checkbox>
							<LABEL style="POSITION: relative; TOP: -1px; font-weight:normal; font-size:10px;" for=ckIncludeSqFt>Add Sq. Ft. to Total</LABEL>
						</DIV>
					</div>
					<div class="SystemInfoDiv" style="padding:0; height:20px;">
						<input id=SysSqFt style="border:none; margin:0; padding:0; width:85%; background:none; top:0; float:left;" value="<%=rs("SqFoot")%>"
						 onchange="SendSQL('Write','UPDATE Systems SET SqFoot=\''+this.value+'\' WHERE SystemID=<%=SysID%>');" 
						 onKeyUp="SendSQL('Write','UPDATE Systems SET SqFoot=\''+this.value+'\' WHERE SystemID=<%=SysID%>');"
						/>
					</div>
				</div>
				...
				<div class="Row">
					<DIV class=SystemInfoDiv style="position:relative; top:0px; width:90.71%; height:18px;" align=left> 
				...
				<!--
				<div class="Row" style="z-index:300010;">
					<DIV class=SystemInfoDiv style="position:relative; top:0px; width:90.71%; height:18px;" align=left> 
						<INPUT style="margin: 3px 0px 0px 4px" id="ckLock" onchange=SysContract(this.checked); type=checkbox>
						<label style="position: relative; TOP: -2px" for="ckLock">Contracted</label>
					</DIV>
				</div>
				-->
				
				<div id="Graph" style="position:relative; top:-0px; width:100%; height:192px; float:left; padding:0; margin:0; overflow:hidden;">
					<iframe id=GraphFrame frameborder=0 style="width:100%; height:100%; padding:0; margin:0;"></iframe>
				</div>
		...
		<!--
		<DIV class=SystemInfoLRBBox style="width:45.35%; float:left; top:0px;">
		</DIV>
		-->
...
<div id="RightBox">
	...
	<div style="border:1px Solid #2E4615;">
		...
		<textarea style="height:172px;" class="SystemInfoNotes" id="BidText" rows="25"
		 onKeyUp="SendSQL('Write','UPDATE Systems SET Notes=\''+CharsEncode(this.value)+'\' WHERE SystemID=<%=SysID%>')"><%=DecodeChars(rs("Notes"))%></textarea>
										
		<div class="SystemInfoRtitle">INCLUDES</div>
										
		<textarea style="height:81px;" class="SystemInfoNotes" id="IncludesText" rows="22"
		 onKeyUp="SendSQL('Write','UPDATE Systems SET Includes=\''+CharsEncode(this.value)+'\' WHERE SystemID=<%=SysID%>')"><%=DecodeChars(rs("Includes"))%></textarea>
										
		<div class="SystemInfoRtitle">EXCLUDES</div>
		<textarea style="height:92px;" class="SystemInfoNotes" id="ExcludesText"  rows="22"
		 onKeyUp="SendSQL('Write','UPDATE Systems SET Excludes=\''+CharsEncode(this.value)+'\' WHERE SystemID=<%=SysID%>')"><%=DecodeChars(rs("Excludes"))%></textarea>
...
-->		
	...
	<div class="SystemLink" Style="width:100%; height:40px; border-left:#000 1px solid; padding:8px; text-align:center;">
