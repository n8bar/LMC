   ...
   if (((Days_in_Month[Month] == 31) && (First_Day >= 6)) ||  ((Days_in_Month[Month] == 30) && (First_Day == 7)))
	 ...
	 {var Rows=5;}
		...
		if(sHead !='')
		{
			...
			HTML_String += 	'<button id="ReloadFrame" onClick="window.location=window.location"><img src="../../LMCManagement/Old Stuff/images/reloadblue24.png" width="100%" height="100%"/></button>';
			HTML_String += '</div>';
		}
