	...
	<div id="CustomInfoBoxOverallDiv" style="height:auto;">
		...
		<div id="CustomInfoBox<%=iBNum%>">
			<div id="iTitle<%=iBNum%>" class="iTitleCustom">
				<img class="CustomIX" src="../../LMCManagement/images/closesmall.gif" onClick="DelInfoBox(<%=rs2("InfoBoxID")%>,this.parentNode.parentNode)"/>
					...
					<div id="infoBox<%=iBNum%>customData">
						...
						Do Until rs3.eof
							...
							<div id="<%=TN%>Div" class="InfoDiv" onClick="try{Gebi('<%=TN%>').focus();} catch(e){}">
								<img src="../../LMCManagement/images/closesmall.gif" style="cursor:pointer;" onClick="DelInfoBoxData(<%=rs3("InfoBoxDataID")%>,this.parentNode);"/>
...
<div id="ScheduTab" class="TabInner2" onClick="DataTabs('Schedu','Schedule');" style="background:#C9E4F8 ;">Schedule</div>
		...
		<div id="JobLogTabBox" class="TabBox2" onMouseOver="MouseOverMarTop('JobLogTabBox')" onMouseOut="MouseOutMarTop('JobLogTabBox')">
			...
			<div id="TabTitle" class="TabTitle">
				<div class="TabTitleCorner"><img src="../../LMCManagement/images/LightGrayGradient2BLCorner24x24.gif" style="float:left; z-index:0;"/></div>
				<div id="TabTitleText" class="TabTitleText">Manage</div>
				<div class="TabTitleCorner" style="width:1px;"><img src="../../LMCManagement/images/LightGrayGradient2BRCorner24x24.gif" style="float:left; z-index:0;"/></div>
			</div>
