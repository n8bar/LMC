...
<%nc=LoadStamp%>
<script type="text/javascript" src="../LMCManagement/Modules/rcstri.js?nc=<%=nc%>" ></script>
<script type="text/javascript" src="../LMCManagement/Calendar/CalendarMain-JS.js?nc=<%=nc%>" ></script>
<script type="text/javascript" src="../LMCManagement/Calendar/CalendarCreate.js?nc=<%=nc%>" ></script>
<script type="text/javascript" src="../LMCManagement/Calendar/CalendarJS.js?nc=<%=nc%>" ></script>
<script type="text/javascript" src="../LMCManagement/Calendar/CalendarAJAX.js?nc=<%=nc%>" ></script>
<script type="text/javascript" src="../LMCManagement/Modules/DragNDropJS.js?nc=<%=nc%>" ></script>
<script type="text/javascript" src="../LMCManagement/Library/dhtmlgoodies_calendar.js?nc=<%=nc%>" ></script>

<script>//alert('finished JavaScript Libraries!');</script>

<script type="text/javascript" >var mX; var mY; </script>

<link rel=stylesheet href="../LMCManagement/Library/CSS_DEFAULTS.css" media=screen >
<link rel=stylesheet href="../LMCManagement/Calendar/CalendarCSS.css" media=screen >
<link rel=stylesheet href="../LMCManagement/Calendar/CalendarMain-CSS.css" media=screen >
<link rel=stylesheet href="calMobile.css" media=screen >
<link type="text/css" rel="stylesheet" href="../LMCManagement/Library/dhtmlgoodies_calendar.css?random=20051112<%=nc%>" media=screen >
