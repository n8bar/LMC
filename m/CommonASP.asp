	...
	Else
		...
		Else
			...
			Else
				...
				If rs2.EOF Then
					Access=Access&"<FName>FName</FName>"
					Access=Access&"<LName>LName</LName>"
					Access=Access&"<Email>--Email</Email>"
				Else
					Access=Access&"<FName>"&rs2("FName")&"</FName>"
					Access=Access&"<LName>"&rs2("LName")&"</LName>"
					Access=Access&"<Email>--"&rs2("Email")&"</Email>"
				End If
