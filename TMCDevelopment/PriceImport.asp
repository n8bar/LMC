...
<div id=PartInfo class=PartInfo height="150px" style="height:25%; min-height:150px;" >
	...
	<div class="fieldColumn w20p" style="height:<%=iColH%>%; min-height:<%=iColMH%>px;">
		<div class=fieldDiv style="<%=InfoCellStyle%> z-index:0;" id=Model ><%=editLink%><div><%=rs("Model")%></div></div>
		<div class=fieldDiv style="<%=InfoCellStyle%>" id=PartNumber><%=editLink%><%=rs("PartNumber")%></div>
		<div class=fieldDiv style="<%=InfoCellStyle%>" id="Manufacturer"><%=editLink&rs("Manufacturer")%></div>
		<div class=fieldDiv style="<%=InfoCellStyle%>" id=System><%=editLink&rs("System")%></div>
	...
	<div class="fieldColumn w20p" style="height:<%=iColH%>%; min-height:<%=iColMH%>px;">
		...
		<div class=fieldDiv id=Category1 style="<%=InfoCellStyle%>"><%=editLink&rs("Category1")%></div>
		<div class=fieldDiv id=Category2 style="<%=InfoCellStyle%>"><%=editLink&rs("Category2")%></div>
	...
	<div class="fieldColumn w20p" style="height:<%=iColH-iRowH%>%; min-height:<%=iColMH-iRowMH%>px;">
		<div class=fieldDiv id=Description style="<%=InfoCellStyle%> height:100%; max-height:100%;"><%=notesLink&rs("Description")%></div>
	</div>
