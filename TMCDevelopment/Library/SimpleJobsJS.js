...
function ArchivedJobListBkGndOn(ID){document.getElementById('ArchivedJobItems'+ID+'').style.background = '#E6F3FB';}

function ArchivedJobListBkGndOff(ID){document.getElementById('ArchivedJobItems'+ID+'').style.background ='#FFF';}
//----------------------------------------------------------------
...
{	
	...
	document.getElementById("JobInfoBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("JobContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToContacts(LoopNum)
{
	...
	document.getElementById("JobInfoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobContactsBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("JobNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToNotes(LoopNum)
{
	...
	document.getElementById("JobInfoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobNotesBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("JobToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToToDo(LoopNum)
{
	...
	document.getElementById("JobContactsBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobToDoBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("JobBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToBOM(LoopNum)
{
	...
	document.getElementById("JobNotesBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobBOMBoxBody"+LoopNum).style.display = 'block';
	document.getElementById("JobDocsBoxBody"+LoopNum).style.display = 'none';
...
function ChangeToDocs(LoopNum)
{
	...
	document.getElementById("JobToDoBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobBOMBoxBody"+LoopNum).style.display = 'none';
	document.getElementById("JobDocsBoxBody"+LoopNum).style.display = 'block';
...
function SelectTreeItem(ThisItem)
{
	...
	PGebi('ItemNotesHead').innerHTML=ThisItem.innerHTML; //Makes Notes-Title match Tree-Item Name
	//ThisItem.style.width=(ThisItem.parentNode.offsetWidth-(ThisItem.parentNode.offsetLeft-ThisItem.offsetLeft)-16)+'px';//Makes highlight fill to the right edge.
...
function ToCal(NoteID)
{
	...
	Target.document.getElementById('FromDateTxt').value = document.getElementById('ItemDateStarted'+SelectedRow).value;
	Target.document.getElementById('ToDateTxt').value = document.getElementById('ItemDateDue'+SelectedRow).value;
	...
	/*
	if(TaskList[i].innerText != TaskList[i].innerText.replace(TaskName[parent.TaskType],''))
	{
		TaskList.selectedIndex = i;
	}
	*/
	//alert(parent.TaskType);
	for(t=0;t<TaskList.length;t++)
		{
		//alert(TaskList[t].value+'->'+parent.TaskType);
		if(TaskList[t].value==parent.TaskType)
		{
