...
<script type="text/javascript" src="Project/ProjJS.js?nc=<%=loadStamp%>"></script>
<script type="text/javascript" src="Project/ProjAJAX.js?nc=<%=loadStamp%>"></script>
<script type="text/javascript" src="Library/SqlAjax.js?nc=<%=loadStamp%>"></script>

<link rel=stylesheet href="Library/ListsCommon.css?nc=<%=loadStamp%>" media="screen">
<link rel=stylesheet href="Project/ProjCSS.css?nc=<%=loadStamp%>" media="screen">


</head>
<body onResize="Resize();" onLoad="Resize(); Gebi('ProjectListFrame').src='ProjectList.asp';" >
...
<div id=NewBidBox class="WindowBox" align="center" >
	...
	<div class=newBidBoxRow style="height:23px;">
		...
		<input id=nbCity type=text class=newBidTxt style="font-size:19px;" onKeyPress="copyCity(this.value);" />
	</div>
...
<div id="OverAllContainer">
	...
	<div id="Lists" class="Lists" align="center">
		...
		<div id="mainToolbar" class="Toolbar" style="background:none; height:48px; text-align:center; width:98%;">
			...
			<div id=path>&nbsp; Projects > <big><b>Project Management</b></big></div>
		...
		<form id=SearchBar class="Toolbar" action="javascript:Search();">
			...
			<label>
				...
				Status:
				<select id=sStatus onChange="sessionWrite('ShownProjects',this.selectedIndex); alert(this.selectedIndex);">
		...
		<div id="ListBody" class="ListBody" align="center">
			...
			<div id="TLItemsContainer" class="TLItemsContainer">
				<iframe id="ProjectListFrame" frameborder="0" scrolling="auto"></iframe>
			</div> 
			...
			<script type="text/javascript">
				var ProjectList=Gebi('ProjectListFrame').contentWindow;
				var Active='True';
		...
		<div id="ToDoToolbar" class="Toolbar" style="text-align:center; margin-left:auto; margin-right:auto; width:100%;">
			...
			<div style="float:left; width:33%; min-width:33%; height:100%;">
				<span id="ProjectListControl" style="float:left; width:100%;">
