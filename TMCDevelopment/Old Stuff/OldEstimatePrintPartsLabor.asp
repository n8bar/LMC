	...
	<div class="PrintBody">
		...
		<%
			...
			Do Until rs1.EOF
				...
				'If rs1("ExcludeSys") <> "True" Or  rs1("ExcludeSys") ="" Then
					SysID = rs1("SystemID")
				...
				%>
					...
					<span class="LineIndent1-4" style="float:left; width:50%; margin:0;">Name</span>
				...
				<%
					...
					SQL2= "SELECT * FROM EstItems WHERE Type='"&PartsOrLabor&"' AND EstimateID="&SysID
					...
					Do Until rs2.EOF
						...
						TCost=Round((rs2("Cost")*100)/100)*rs2("Qty")
					%>
						<span class="LineIndent1-4" style="float:left; width:50%; margin:0;"><%=rs2("ItemName")%></span>
						<span class="LineIndent1-4" style="float:left; width:20%; margin:0;"><%=rs2("Qty")%></span>
				...
				%>
					<br/>
					<div class="Line">
						<div class="SystemTitle" style="float:left; width:50%; margin:0;"><big>Total for <%=rs1("System")%></big></div>
						<div class="SystemTitle" style="float:left; width:20%; margin:0;"><%=SysUnits%></div>
						<div class="SystemTitle" style="float:right; width:20%; margin:0;"><big>$<%=SysCost%></big></div>
					</div>
					<hr style="margin-bottom:0;" />
					<hr style="margin-top:0;" />
				<%
		...
		<br/>
		<div class="Line">
			<div class="SystemTitle" style="float:left; width:50%; margin:0;"><big><big><big>Project Total</big></big></big></div>
			<div class="SystemTitle" style="float:left; width:20%; margin:0;"><big><%=Units%></big></div>
			<div class="SystemTitle" style="float:right; width:20%; margin:0;"><big><big>$<%=Cost%></big></big></div>
		</div>
		<hr style="margin-bottom:0;" />
		<hr style="margin-top:0;" />
